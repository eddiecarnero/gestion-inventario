...
public class SubirInsumosPage extends BorderPane {
    ...
    public static class FilaCreacion {
        ...
        public FilaCreacion(String n, String p, Double pr, Double c, String u, Integer min, String ub) {
            setNombre(n); setProveedor(p); setPrecio(pr); setContenido(c); setUnidad(u); setStockMin(min); setUbicacion(ub); setEstado("Pendiente");
        }

        // Getters/Properties (Sin .asObject() aquí, ya son ObjectProperty)
        public String getNombre() { return nombre.get(); } public void setNombre(String v) { nombre.set(v); } public StringProperty nombreProperty() { return nombre; }
        public String getProveedor() { return proveedor.get(); } public void setProveedor(String v) { proveedor.set(v); } public StringProperty proveedorProperty() { return proveedor; }
        public Double getPrecio() { return precio.get(); } public void setPrecio(Double v) { precio.set(v); } public ObjectProperty<Double> precioProperty() { return precio; }
        public Double getContenido() { return contenido.get(); } public void setContenido(Double v) { contenido.set(v); } public ObjectProperty<Double> contenidoProperty() { return contenido; }
        public String getUnidad() { return unidad.get(); } public void setUnidad(String v) { unidad.set(v); } public StringProperty unidadProperty() { return unidad; }
        public Integer getStockMin() { return stockMin.get(); } public void setStockMin(Integer v) { stockMin.set(v); } public ObjectProperty<Integer> stockMinProperty() { return stockMin; }
        public String getUbicacion() { return ubicacion.get(); } public void setUbicacion(String v) { ubicacion.set(v); } public StringProperty ubicacionProperty() { return ubicacion; }
        public String getEstado() { return estado.get(); } public void setEstado(String v) { estado.set(v); } public StringProperty estadoProperty() { return estado; }
    }
}