...
public class Almacen1Page extends BorderPane {
    ...
    private TableView<InsumoUI> tablaInsumos;
    private TextField searchField;
    private ObservableList<InsumoUI> todosLosInsumos = FXCollections.observableArrayList();
    private FilteredList<InsumoUI> filteredInsumos;
    ...
    private void configurarTabla() {
        ...
        TableColumn<InsumoUI, String> nombreCol = new TableColumn<>("Insumo");
        nombreCol.setCellValueFactory(new PropertyValueFactory<>("nombre"));

        TableColumn<InsumoUI, Integer> stockCol = new TableColumn<>("Cantidad");
        ...
        stockCol.setCellFactory(col -> new TableCell<>() {
            @Override protected void updateItem(Integer item, boolean empty) {
                ...
                InsumoUI row = getTableView().getItems().get(getIndex());
                if (row.esStockBajo()) setStyle("-fx-text-fill: #DC2626; -fx-font-weight: bold;");
                else setStyle("");
            }
        });

        TableColumn<InsumoUI, String> unidadCol = new TableColumn<>("Unidad");
        unidadCol.setCellValueFactory(new PropertyValueFactory<>("unidad"));

        TableColumn<InsumoUI, Double> precioCol = new TableColumn<>("Precio Unit.");
        ...
        TableColumn<InsumoUI, Integer> minCol = new TableColumn<>("Stock Mín.");
        minCol.setCellValueFactory(new PropertyValueFactory<>("stockMinimo"));

        TableColumn<InsumoUI, String> provCol = new TableColumn<>("Proveedor");
        provCol.setCellValueFactory(new PropertyValueFactory<>("proveedorNombre"));

        TableColumn<InsumoUI, String> estadoCol = new TableColumn<>("Estado");
        ...
        TableColumn<InsumoUI, Void> accionesCol = new TableColumn<>("Detalle");
        accionesCol.setCellFactory(param -> new TableCell<>() {
...

            {
                ...
                btnVer.setOnAction(event -> {
                    InsumoUI insumo = getTableView().getItems().get(getIndex());
    ...
    private void mostrarDialogoLotes(InsumoUI insumo) {
        ...
        // Cargar datos
        ObservableList<LoteUI> datosLotes = FXCollections.observableArrayList();
