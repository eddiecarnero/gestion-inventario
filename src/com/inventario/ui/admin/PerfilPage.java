...
public class PerfilPage extends BorderPane {
    ...
    private void guardarUsuario() {
        ...
        // Nota: idUsuarioEditando es null si es nuevo, o un entero si editamos. Usamos 0 si es nuevo.
        int id = (idUsuarioEditando == null) ? 0 : idUsuarioEditando;
        boolean esNuevo = (idUsuarioEditando == null);
        ...
        if (dao.guardarUsuario(usuario, esNuevo)) {
            mostrarAlerta("Éxito", esNuevo ? "Usuario creado." : "Usuario actualizado.");
            limpiarFormularioUser();
            cargarUsuarios();
        } else {
            mostrarAlerta("Error", "No se pudo guardar el usuario. Revise los datos.");
        }
    }
    ...
    private void eliminarUsuario() {
        ...
        UsuarioDAO dao = new UsuarioDAO();
        if (dao.eliminarUsuario(idUsuarioEditando)) {
